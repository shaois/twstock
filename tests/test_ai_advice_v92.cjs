...
assert.match(check({...base,...negative},negative).decisionIssue,/矛盾/);
...
assert.ok(check({...base,expected_net_return:null},{...forecast,expected_net_return:null}).decisionIssue);
